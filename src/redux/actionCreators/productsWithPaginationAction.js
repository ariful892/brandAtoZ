...
const loadsAllProducts=()=>async(dispatch,getState)=>{
    

      dispatch({type:PRODUCTS_PAGINATION_REQUEST})
      
    try {
        const res=await fetch(`https://backend.dokanbhai.dokanbhai.com:3002/api/products?pageNumber=&seller=&name=&category=&min=0&max=0&rating=0&order=newest&flash_sale=&fbclid=IwAR1ZjlVfQ47TbVJYFcWSMX3adhBvcUazy9TRLydJiWYksGh5pxsVOuoXYOM`)
